...
Данный проект представляет собой backend-приложение, реализующее собственную систему аутентификации и авторизации без использования встроенной системы Django auth.

Основная цель проекта — демонстрация понимания принципов:
...
- управление правилами доступа (только admin)
